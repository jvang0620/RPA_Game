...
public class RPSGame {
    ...
    public static void main(String[] args) {
        ...
        String welcomeMessage = "Welcome everyone! We are so glad you are here!";
        System.out.println(welcomeMessage);

        String promptingUser = "Enter 1, 2, or 3. Pick only one numner!1";
        String promptingUser2 = "1 is Rock, 2 is Paper, 3 is Scissor";

        System.out.println(promptingUser);
        System.out.println(promptingUser2);

        // Add print statement to welcome User to the game
        // Add print statement prompting User to enter 1, 2, or 3 (explain which each
        // number represents)
        // User scnr.nextInt() to collect user input, save it as an int variable called
        // choice
        int choice = scnr.nextInt();

        int computerChoice = (int) (Math.random() * 3 + 1);

        // Complete this line using Math.Random() to generate a int
        // In the range 1-3
